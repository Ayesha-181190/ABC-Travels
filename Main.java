...
public class Main {
    ...
    private static boolean displayCompanyLogo() {
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\User1\\Desktop\\ABC Travels.txt"))) {
            String line;
    ...
    private static void showMenuOptions() throws SQLException {
